...
def RunExperiment(prefix, data_path, save_path, model_path, refd_path, epochs, models_dict, losses_dict, lr_dict, bs_dict):
    ...
    inputs_dict = {
        'ece3': {
            'prec' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_PREC_DAY_1979_2023_RBIL_LOG.npy',

            'z850' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_ZG850_DAY_1979_2023_RBIL_STD.npy',
            'z700' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_ZG700_DAY_1979_2023_RBIL_STD.npy',
            'z500' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_ZG500_DAY_1979_2023_RBIL_STD.npy',

            'q850' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_HUS850_DAY_1979_2023_RBIL_STD.npy',
            'q700' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_HUS700_DAY_1979_2023_RBIL_STD.npy',
            'q500' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_HUS500_DAY_1979_2023_RBIL_STD.npy',

            't850' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_TA850_DAY_1979_2023_RBIL_STD.npy',
            't700' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_TA700_DAY_1979_2023_RBIL_STD.npy',
            't500' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_TA500_DAY_1979_2023_RBIL_STD.npy',

            'u850' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_UA850_DAY_1979_2023_RBIL_STD.npy',
            'u700' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_UA700_DAY_1979_2023_RBIL_STD.npy',
            'u500' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_UA500_DAY_1979_2023_RBIL_STD.npy',

            'v850' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_VA850_DAY_1979_2023_RBIL_STD.npy',
            'v700' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_VA700_DAY_1979_2023_RBIL_STD.npy',
            'v500' : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_VA500_DAY_1979_2023_RBIL_STD.npy',

            'msl'  : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_PSL_DAY_1979_2023_RBIL_STD.npy',
            't2m'  : f'{DATA_PATH}/IND32M_HRMIP_EC-Earth3P_100_TAS_DAY_1979_2023_RBIL_STD.npy',
            } 
        }
